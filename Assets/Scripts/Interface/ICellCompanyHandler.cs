...
public interface ICellCompanyHandler
{
...
public abstract class BaseCompanyHandler : ICellCompanyHandler
{
...
public class DefaultCompanyHandler : BaseCompanyHandler
{
    ...
    {
        var cell = boardService.GetCellData(cellIndex);
    ...
    {
        return boardService.GetCellData(cellIndex).companyData.price;
    }
...
public class FieldCompanyHandler : BaseCompanyHandler
{
    ...
    public override int GetPrice(int cellIndex)
    {
        return boardService.GetCellData(cellIndex).fieldCompanyData.price;
    }
...
public class DiceCompanyHandler : BaseCompanyHandler
{
    ...
    public override int GetPrice(int cellIndex)
    {
        return boardService.GetCellData(cellIndex).diceCompanyData.price;
    }
