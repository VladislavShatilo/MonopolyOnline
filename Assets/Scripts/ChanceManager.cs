...
public class ChanceManager : MonoBehaviourPun
{
   // public static ChanceManager Instance { get; private set; }
    ...
    private void InitializeBuffs()
    {
        ...
        buffs.Add(new ChanceBuff(BuffType.MoneyGainRandom1, 2, 250, 1000));
        buffs.Add(new ChanceBuff(BuffType.MoneyGainRandom2, 3, 500, 1500));
        buffs.Add(new ChanceBuff(BuffType.MoneyGainFixed, 1, 1500, 1500));
        buffs.Add(new ChanceBuff(BuffType.MoneyLoseRandom1, 2, 250, 1000));
        buffs.Add(new ChanceBuff(BuffType.MoneyLoseRandom2, 2, 500, 1500));
        buffs.Add(new ChanceBuff(BuffType.MoneyLoseFixed, 2, 1500, 1500));
        buffs.Add(new ChanceBuff(BuffType.Teleport, 2));
        buffs.Add(new ChanceBuff(BuffType.SkipTurn, 2));
        buffs.Add(new ChanceBuff(BuffType.ReverseMove, 1));
        buffs.Add(new ChanceBuff(BuffType.Jail, 1));
    }
